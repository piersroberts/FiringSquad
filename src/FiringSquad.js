function FiringSquad() {
    ...
    return{
         ...
         * @returns {Boolean}
         */
        id: function(id) {return self.idExists(id);},
        /**
         * Returns whether or not a class exists in a DOM
         * @param {String} className
         * @returns {Boolean}
         */
        class: function(className) {return self.classExists(className);},
        /**
